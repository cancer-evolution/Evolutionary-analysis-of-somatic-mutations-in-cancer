...
CNV_df <- load_CNVs_gistic(only_focal="ANY")###In paper was focal.
...
percentage_UC_EM_MM_alt <- add_mut_CNV_to_degree_df_mutsig(percentage_UC_per_gene_directed[,c("Genes","Degree","Age","Database")], all_mut_common,
...
per_UC_EM_downstream$Alt_binary <- ifelse(per_UC_EM_downstream$Alt %in% c("Mut"), "Point",
