...
save(CNV, file="CNV2.Rdata")  #now excluding amplification that do not cover entire gene
#and selecting the maximum segment mean for amplifications, and min for deletions
