...
sum(c(all_miss_common, all_lof_common) %in% regulators)/length(c(all_miss_common, all_lof_common))*100
sum(c(all_amp_common, all_del_common) %in% regulators)/length(c(all_amp_common, all_del_common))*100

sum(c(all_miss_common, all_lof_common) %in% non_regulator_targets)/length(c(all_miss_common, all_lof_common))*100
...
fraction_gene_class_all_melt$Alteration <- factor(fraction_gene_class_all_melt$Alteration, levels=c("Miss", "LoF", "Amp", "Del"))
...
wilcox.test(fraction_gene_class_all_melt_reg$Fraction[fraction_gene_class_all_melt_reg$Alteration == "LoF"],
            fraction_gene_class_all_melt_reg$Fraction[fraction_gene_class_all_melt_reg$Alteration %in% c("Amp", "Del")], alternative = "greater")
wilcox.test(fraction_gene_class_all_melt_reg$Fraction[fraction_gene_class_all_melt_reg$Alteration == "Miss"],
            fraction_gene_class_all_melt_reg$Fraction[fraction_gene_class_all_melt_reg$Alteration %in% c("Amp", "Del")], alternative = "greater")
...
wilcox.test(fraction_gene_class_all_melt_tar$Fraction[fraction_gene_class_all_melt_tar$Alteration == "Amp"],
            fraction_gene_class_all_melt_tar$Fraction[fraction_gene_class_all_melt_tar$Alteration %in% c("Miss", "LoF")],  alternative = "greater")
